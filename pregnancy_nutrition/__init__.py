"""FemVerse pregnancy + nutrition ADK app.
...
It re-exports ``root_agent`` (built from ``pregnancy_nutrition/root_agent.yaml``)
so the ADK CLI can find it without any further configuration.
