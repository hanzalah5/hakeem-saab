"""FemVerse nutrition / dietary ADK app.
...
It re-exports ``root_agent`` (built from ``nutrition/root_agent.yaml``) so the
...
"""The FemVerse nutrition specialist, discovered by the ADK CLI."""
