...
- `fetch_daily_logs(user_id)` — call when the answer hinges on current gestational data, symptoms, fetal-movement counts, BP readings, mood, sleep, or other recent logs.
