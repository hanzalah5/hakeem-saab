...
- `fetch_daily_logs(user_id)` — call when the answer hinges on current cycle data, symptoms, mood, sleep, or other time-series logs. Prefer the most recent entries.
